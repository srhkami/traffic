...
<!--    </span>-->
    <div class="alert alert-info m-0 p-2 ms-2" role="alert">
      <a class="text-warning" href="https://trafficpigeon.com/" style="text-decoration: none;">
      交通鴿手搬家了！前往新版網站
      </a>
...
const asideHtml = `
  ...
  <div id="webMenu" class="rounded-3 px-2 h-100 overflow-auto">  
    ...
    <div class="arriveTerm card border-2 border-primary-subtle mt-2 ${showTools(toolsSet()[2])}">
    ...
    <div class="arriveTerm card border-primary-subtle border-2 mt-2 mb-2 ${showTools(toolsSet()[3])}">
